          ...
          <div class="content">
              ...
              <div class="container p-0">
                  <nav class="navbar navbar-expand-lg bg-secondary navbar-dark">
                      <h4 href="" class="navbar-brand d-block d-lg-none">Menu</h4>
                  ...
                  <div class="row py-5 px-4">
                      ...
                      <div class="col-sm-6 text-center text-md-right">
                          <div class="d-inline-flex pt-2">
                              <h4 class="m-0 text-white"><Link class="text-white" to="/">Home</Link></h4>
              ...
              <div class="container py-5 px-2 bg-white">
                  <div class="row px-4">
                      <div class="col-12">
                          <img class="img-fluid mb-4" src={detail} alt="Image" />
                          ...
                          <img class="w-50 float-left mr-4 mb-3" src={blog1} alt="Image" />
                      ...
                      <div class="col-12 py-4">
                          ...
                          <div class="media mb-4">
                              <img src={user} alt="Image" class="mr-3 mt-1 rounded-circle" style={{ width:"60px"}} />
                          ...
                          <div class="media mb-4">
                              <img src={user} alt="Image" class="mr-3 mt-1 rounded-circle"
                                  style={{ width:"60px"}} />
                              <div class="media-body">
                                  <h4>John Doe <small><i>01 Jan 2045 at 12:00pm</i></small></h4>
                                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
